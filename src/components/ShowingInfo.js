            ...
            <div>
                <Container>
                    <Card style={{ width: '18rem' ,margin: '0 auto', color:'blue' }}>
                        <Card.Img variant="top" src={`https://maps.locationiq.com/v3/staticmap?key=${process.env.REACT_APP_api_key}&q&center=${this.props.cityInfo.lat},${this.props.cityInfo.lon}&zoom=20`}/>
                        <Card.Body>
